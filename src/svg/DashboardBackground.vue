<template>
    <svg version="1.2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="graph" viewBox="0 0 550 550" preserveAspectRatio="xMinYMax meet" width="100px" height="100px">
      ...
      <g class="grid y-grid" id="yGrid">
        ...
        <text x="235" y="400">Sidewalk</text>
